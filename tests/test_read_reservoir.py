...
def test_create_reservoir() -> None:
    ...
    assert reservoir.weekly_inflow[2, 0] == 4509 * 7
    assert len(reservoir.max_weekly_turb) == 52
    assert reservoir.max_weekly_turb[0] == 8400000
    assert reservoir.max_weekly_pump[0] == 8400000
